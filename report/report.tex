...
\captionof{figure}{Spark and Ray exhibit similar speedup for triangle counting when increasing worker count.}
\end{figure}
...
\captionof{figure}{k-means: Spark used 5\% less memory when scaling. Ray didn't show improvement.}
\end{figure}
